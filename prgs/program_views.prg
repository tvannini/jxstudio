...
o2def::prg("program_views", "start", "", __FILE__);

o2def::view('prg§_§var');
o2def::view("obj_status", false, "", "", 1, 0);
o2def::view("prgexps", false, "", "", 0, 0);
o2def::view("prgviews", false, "", "", 0, 0);
o2def::act("checkin");
o2def::act("checkout");
o2def::act("close");
o2def::act("discard");
o2def::act("exit");
o2def::act("prgviews_delete");
o2def::act("prgviews_detail");
o2def::act("prgviews_insert");
o2def::act("save");
...
o2def::act("uncheck");
o2def::form("prg_views", "", False, "true", false);
